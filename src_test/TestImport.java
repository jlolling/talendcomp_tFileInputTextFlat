...
import de.cimt.talendcomp.flatfileimport.CSVFieldTokenizer;
import de.cimt.talendcomp.flatfileimport.CSVFileDatasetProvider;
import de.cimt.talendcomp.flatfileimport.DatasetProvider;
import de.cimt.talendcomp.flatfileimport.FieldDescription;
import de.cimt.talendcomp.flatfileimport.ImportAttributes;
import de.cimt.talendcomp.flatfileimport.Importer;
import de.cimt.talendcomp.flatfileimport.ParserException;
...
public class TestImport {
	...
	public static void testTokenizer() { 
		...
		t.setRowData(line);
		try {
			System.out.println(t.extractDataAtDelimiter(0, 0));
			System.out.println(t.extractDataAtDelimiter(1, 0));
			System.out.println(t.extractDataAtDelimiter(2, 0));
			System.out.println(t.extractDataAtDelimiter(3, 0));
			System.out.println(t.extractDataAtDelimiter(4, 0));
